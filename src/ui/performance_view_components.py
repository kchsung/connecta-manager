...
def render_performance_view_tab():
    ...
    if performance_data:
        ...
        column_config = {
            ...
            "조회수": st.column_config.NumberColumn("조회수", min_value=0, step=1, format="%d"),
            "좋아요": st.column_config.NumberColumn("좋아요", min_value=0, step=1, format="%d"),
            "댓글": st.column_config.NumberColumn("댓글", min_value=0, step=1, format="%d"),
